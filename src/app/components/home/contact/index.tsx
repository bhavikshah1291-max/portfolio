...
const Contact = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    fetch("https://formsubmit.co/ajax/bhavik.shah.1291@gmail.com", {
      method: "POST",
  ...
  return (
    <section id="contact-me" className="no-print">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col gap-7 sm:gap-12">
                ...
                <button
                  type="submit"
                  className=" download relative overflow-hidden cursor-pointer w-fit py-2 sm:py-3 md:py-5 px-4 sm:px-5 md:px-7 border border-primary rounded-full group"
                >
